...
# ============================================================
# EXP19 — stream-of-search traces  (Batch-2 Idea 9)
# Base: Continuer_Nemotron_Notebook.py (unmodified except marked blocks)
# Change: optionally train on regenerated search-trace corpus  |  Knob: SOS_CORPUS=None  |  Rollback: set SOS_CORPUS=None
# ============================================================
...
# >>> EXP19 START
SOS_CORPUS = None
# Main EXP19 work is upstream in nemotron-master/ reasoners for cryptarithm/cipher.
...
def run_training() -> None:
    ...
    # >>> EXP19 START
    if SOS_CORPUS is not None:
        CORPUS_PATH = SOS_CORPUS
        print(f"EXP19 using stream-of-search corpus: {CORPUS_PATH}")
    # <<< EXP19 END
