...
# ============================================================
# EXP7 - STaR/RFT self-generated verified traces  (Batch-1 Idea 7)
# Base: Continuer_Nemotron_Notebook.py (unmodified except marked blocks)
# Change: merge optional verified extra trace jsonl   |   Knob: STAR_EXTRA_PATH=None   |   Rollback: leave STAR_EXTRA_PATH=None
# ============================================================
    ...
    if STAR_EXTRA_PATH and os.path.isfile(STAR_EXTRA_PATH):
        ...
        with open(STAR_EXTRA_PATH) as f:
            for line in f:
                ...
                added += 1
        print(f"EXP7 STaR: merged {added} extra traces from {STAR_EXTRA_PATH}")
    elif STAR_EXTRA_PATH:
        print(f"EXP7 STaR: STAR_EXTRA_PATH not found: {STAR_EXTRA_PATH}")
    # <<< EXP7 END
