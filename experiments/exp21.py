...
# ============================================================
# EXP21 — Solver verifier gate + category length cap  (Batch-3 Idea 2, DATA-AUG)
# Base: Continuer_Nemotron_Notebook.py (unmodified except marked blocks)
# Upstream: nemotron-master/corpus.py verify+length gates  |  Corpus: EXP21_GATED_CORPUS
# Change: optionally train on gated regenerated corpus  |  Knob: EXP21_GATED_CORPUS=None  |  Rollback: set EXP21_GATED_CORPUS=None
# ============================================================
...
# >>> EXP21 START
# Main EXP21 work is upstream in nemotron-master/corpus.py.
...
def run_training() -> None:
    ...
    # >>> EXP21 START
    if EXP21_GATED_CORPUS and IS_KAGGLE:
        CORPUS_PATH = os.path.join(EXP21_GATED_CORPUS, "tokens")
        TRAIN_ORDER_PATH = os.path.join(EXP21_GATED_CORPUS, "logprobs", "index.jsonl")
        print(f"EXP21 using gated snapshot root: {EXP21_GATED_CORPUS}")
    # <<< EXP21 END
