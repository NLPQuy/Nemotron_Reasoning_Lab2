...
# ============================================================
# EXP13 — self-verification traces  (Batch-2 Idea 3)
# Base: Continuer_Nemotron_Notebook.py (unmodified except marked blocks)
# Change: optionally train on regenerated verify-trace corpus  |  Knob: VERIFY_TRACES_CORPUS=None  |  Rollback: set VERIFY_TRACES_CORPUS=None
# ============================================================
...
# >>> EXP13 START
VERIFY_TRACES_CORPUS = None
# Main EXP13 work is upstream in nemotron-master/ reasoners + corpus.py.
...
def run_training() -> None:
    ...
    # >>> EXP13 START
    if VERIFY_TRACES_CORPUS is not None:
        CORPUS_PATH = VERIFY_TRACES_CORPUS
        print(f"EXP13 using self-verification corpus: {CORPUS_PATH}")
    # <<< EXP13 END
