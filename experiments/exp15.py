...
# ============================================================
# EXP15 — arithmetic scratchpad corpus  (Batch-2 Idea 5)
# Base: Continuer_Nemotron_Notebook.py (unmodified except marked blocks)
# Change: optionally train on regenerated arithmetic-scratchpad corpus  |  Knob: SCRATCHPAD_CORPUS=None  |  Rollback: set SCRATCHPAD_CORPUS=None
# ============================================================
...
# >>> EXP15 START
SCRATCHPAD_CORPUS = None
# Main EXP15 work is upstream in nemotron-master/ store_types.py + reasoners.
# If set, this path replaces CORPUS_PATH; otherwise the original corpus is used.
# <<< EXP15 END
...
def run_training() -> None:
    ...
    # >>> EXP15 START
    if SCRATCHPAD_CORPUS is not None:
        CORPUS_PATH = SCRATCHPAD_CORPUS
        print(f"EXP15 using arithmetic scratchpad corpus: {CORPUS_PATH}")
    # <<< EXP15 END
