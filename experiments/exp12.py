...
# ============================================================
# EXP12 — NEFTune noisy embeddings  (Batch-2 Idea 2)
# Base: Continuer_Nemotron_Notebook.py (unmodified except marked blocks)
# Change: add train-time embedding noise regularization  |  Knob: NEFTUNE_ALPHA=10.0  |  Rollback: set NEFTUNE_ALPHA=0
# ============================================================
