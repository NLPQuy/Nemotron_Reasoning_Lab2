...
# >>> EXP39 START
# EXP39 - AdaSTaR difficulty-weighted S+R mix using P0 pass-counts.
# Knobs: continue adapter, LR=1e-5, NUM_STEPS=202, CORPUS_PATH=mix_adastar.
# Rollback: use Continuer_Nemotron_Notebook.py or remove EXP39 overrides.
# >>> EXP39 END
...
LEARNING_RATE = 1e-5
RESET_WEIGHTS = False
EXP39_MODAL_CORPUS_PATH = "/data/corpus/mix_adastar.jsonl"
# >>> EXP39 END
IN_PROJ_ONLY = False
...
# >>> EXP39 START
KAGGLE_DATASET = "huikang/nemotron-exp39-adastar"
# >>> EXP39 END
MINUTES = 60
...
def run_training() -> None:
    ...
    if IS_KAGGLE:
        ...
        # >>> EXP39 START
        CORPUS_PATH = "/kaggle/input/datasets/ngoczhu/nemotron-mixes/mix_adastar.jsonl"
        # >>> EXP39 END
        ...
        # >>> EXP39 START
        CORPUS_PATH = EXP39_MODAL_CORPUS_PATH
        # >>> EXP39 END
