...
# >>> EXP35 START
# EXP35 - Short-tier bit length curriculum on top of solver-plus-RFT mix.
# Knobs: continue adapter, LR=1e-5, NUM_STEPS=287, CORPUS_PATH=mix_length.
# Rollback: drop H_lengthcur if held-out long bit-zero does not improve.
# >>> EXP35 END
...
LEARNING_RATE = 1e-5
RESET_WEIGHTS = False
EXP35_MODAL_CORPUS_PATH = "/data/corpus/mix_length.jsonl"
# >>> EXP35 END
IN_PROJ_ONLY = False
...
# >>> EXP35 START
KAGGLE_DATASET = "huikang/nemotron-exp35-length"
# >>> EXP35 END
MINUTES = 60
...
def run_training() -> None:
    ...
    if IS_KAGGLE:
        ...
        # >>> EXP35 START
        CORPUS_PATH = "/kaggle/input/datasets/ngoczhu/nemotron-mixes/mix_length.jsonl"
        # >>> EXP35 END
        ...
        # >>> EXP35 START
        CORPUS_PATH = EXP35_MODAL_CORPUS_PATH
        # >>> EXP35 END
