...
# >>> EXP37 START
# EXP37 - Evolve/SAND solver-verified harder variants on top of RFT mix.
# Knobs: continue adapter, LR=1e-5, NUM_STEPS=310, CORPUS_PATH=mix_evolve.
# Rollback: drop E_evolve if held-out category-level metrics do not improve.
# >>> EXP37 END
...
LEARNING_RATE = 1e-5
RESET_WEIGHTS = False
EXP37_MODAL_CORPUS_PATH = "/data/corpus/mix_evolve.jsonl"
# >>> EXP37 END
IN_PROJ_ONLY = False
...
# >>> EXP37 START
KAGGLE_DATASET = "huikang/nemotron-exp37-evolve"
# >>> EXP37 END
MINUTES = 60
...
def run_training() -> None:
    ...
    if IS_KAGGLE:
        ...
        # >>> EXP37 START
        CORPUS_PATH = "/kaggle/input/datasets/ngoczhu/nemotron-mixes/mix_evolve.jsonl"
        # >>> EXP37 END
        ...
        # >>> EXP37 START
        CORPUS_PATH = EXP37_MODAL_CORPUS_PATH
        # >>> EXP37 END
