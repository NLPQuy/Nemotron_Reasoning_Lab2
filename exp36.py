...
# >>> EXP36 START
# EXP36 - Weakness-targeted bit family synthesis on top of solver-plus-RFT mix.
# Knobs: continue adapter, LR=1e-5, NUM_STEPS=254, CORPUS_PATH=mix_weakness.
# Rollback: drop I_weakness or fallback EXP-E uniform if target families do not improve.
# >>> EXP36 END
...
LEARNING_RATE = 1e-5
RESET_WEIGHTS = False
EXP36_MODAL_CORPUS_PATH = "/data/corpus/mix_weakness.jsonl"
# >>> EXP36 END
IN_PROJ_ONLY = False
...
# >>> EXP36 START
KAGGLE_DATASET = "huikang/nemotron-exp36-weakness"
# >>> EXP36 END
MINUTES = 60
...
def run_training() -> None:
    ...
    if IS_KAGGLE:
        ...
        # >>> EXP36 START
        CORPUS_PATH = "/kaggle/input/datasets/ngoczhu/nemotron-mixes/mix_weakness.jsonl"
        # >>> EXP36 END
        ...
        # >>> EXP36 START
        CORPUS_PATH = EXP36_MODAL_CORPUS_PATH
        # >>> EXP36 END
