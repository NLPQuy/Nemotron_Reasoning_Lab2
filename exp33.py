...
# >>> EXP33 START
# EXP33 - TokenSkip compressed bit solver traces plus mined positives.
# Knobs: continue adapter, LR=1e-5, NUM_STEPS=193, CORPUS_PATH=mix_tokenskip.
# Rollback: use mix_rft if compressed bit rows hurt held-out bit or strong categories.
# >>> EXP33 END
...
LEARNING_RATE = 1e-5
RESET_WEIGHTS = False
EXP33_MODAL_CORPUS_PATH = "/data/corpus/mix_tokenskip.jsonl"
# >>> EXP33 END
IN_PROJ_ONLY = False
...
# >>> EXP33 START
KAGGLE_DATASET = "huikang/nemotron-exp33-tokenskip"
# >>> EXP33 END
MINUTES = 60
...
def run_training() -> None:
    ...
    if IS_KAGGLE:
        ...
        # >>> EXP33 START
        CORPUS_PATH = "/kaggle/input/datasets/ngoczhu/nemotron-mixes/mix_tokenskip.jsonl"
        # >>> EXP33 END
        ...
        # >>> EXP33 START
        CORPUS_PATH = EXP33_MODAL_CORPUS_PATH
        # >>> EXP33 END
