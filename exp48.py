...
# >>> EXP48 START
# EXP48 — Freeze-A: train LoRA B only (Batch-6 B6-4)
# Ref: plan-batch-6.md §exp48 (Hayou 2406.08447; A/B-asymmetry, mạch exp21) | Rollback: FREEZE_LORA_A=False
...
BATCH_SIZE = 32
MICRO_BATCH_SIZE = 4
# >>> EXP48_CONT START   (continue-train từ 0.86 — luật batch-6)
