...
# >>> EXP32 START
# EXP32 - Step-localized REDI negatives from gold-divergence masks.
# Knobs: continue adapter, LR=1e-5, NUM_STEPS=218, lambda_step=0.5, CORPUS_PATH=mix_stepneg.
# Rollback: drop F_stepneg if strong-category pass@1 falls or arithmetic_slip does not improve.
# >>> EXP32 END
...
LEARNING_RATE = 1e-5
RESET_WEIGHTS = False
EXP32_MODAL_CORPUS_PATH = "/data/corpus/mix_stepneg.jsonl"
# >>> EXP32 END
IN_PROJ_ONLY = False
...
# >>> EXP32 START
KAGGLE_DATASET = "huikang/nemotron-exp32-stepneg"
# >>> EXP32 END
MINUTES = 60
...
def run_training() -> None:
    ...
    if IS_KAGGLE:
        ...
        # >>> EXP32 START
        CORPUS_PATH = "/kaggle/input/datasets/ngoczhu/nemotron-mixes/mix_stepneg.jsonl"
        # >>> EXP32 END
        ...
        # >>> EXP32 START
        CORPUS_PATH = EXP32_MODAL_CORPUS_PATH
        # >>> EXP32 END
