# %% [markdown]
# # Batch-7 LoRA fusion (ZERO-TRAIN) — exp60
# Self-contained Kaggle CPU notebook: attach the 5x0.86 adapter dataset, Run All -> submission.zip.
# >>> EXP60 START
# EXP60 — B7-13 LoRA-LEGO — MSU rank-wise k-means fusion, rank-k by construction.
# Mode: lego(auto_pool(), k=32): pool N*32 rank-1 units, k-means to 32 clusters, centroids -> A,B.
# Note: ⭐ submit candidate. P8 sign-canonicalised; P9 sqrt(r/k)=1 dropped.
...
deploy_check(OUT)
zip_submission(OUT)
print("exp60 done: /kaggle/working/submission.zip")
