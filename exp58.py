# %% [markdown]
# # Batch-7 LoRA fusion (ZERO-TRAIN) — exp58
# Self-contained Kaggle CPU notebook: attach the 5x0.86 adapter dataset, Run All -> submission.zip.
# >>> EXP58 START
# EXP58 — B7-1 uniform LoRA soup — uniform product-SVD average of ALL discovered adapters.
# Mode: soup(auto_pool())  — merge product dW=B@A then SVD-truncate rank 32 (L0.3/L0.4).
# Note: ⭐ submit #1 candidate. Auto-sweeps every adapter in the dataset (add more = swept).
...
deploy_check(OUT)
zip_submission(OUT)
print("exp58 done: /kaggle/working/submission.zip")
