...
# >>> EXP29 START
# EXP29 - REDI negatives over full solver anchor plus mined positives.
# Knobs: continue adapter, LR=1e-5, NUM_STEPS=298, lambda=0.8, CORPUS_PATH=mix_redi.
# Rollback: drop N_neg or reduce lambda to 0.4 if format_rate_wrong rises.
# >>> EXP29 END
...
LEARNING_RATE = 1e-5
RESET_WEIGHTS = False
EXP29_MODAL_CORPUS_PATH = "/data/corpus/mix_redi.jsonl"
# >>> EXP29 END
IN_PROJ_ONLY = False
...
# >>> EXP29 START
KAGGLE_DATASET = "huikang/nemotron-exp29-redi"
# >>> EXP29 END
MINUTES = 60
...
def run_training() -> None:
    ...
    if IS_KAGGLE:
        ...
        # >>> EXP29 START
        CORPUS_PATH = "/kaggle/input/datasets/ngoczhu/nemotron-mixes/mix_redi.jsonl"
        # >>> EXP29 END
        ...
        # >>> EXP29 START
        CORPUS_PATH = EXP29_MODAL_CORPUS_PATH
        # >>> EXP29 END
