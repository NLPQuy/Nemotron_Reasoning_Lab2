...
# >>> EXP38 START
# EXP38 - RFT-mined positives on top of full solver anchor.
# Knobs: continue adapter, LR=1e-5, NUM_STEPS=202, CORPUS_PATH=mix_rft.
# Rollback: use Continuer_Nemotron_Notebook.py or remove EXP38 overrides.
# >>> EXP38 END
...
LEARNING_RATE = 1e-5
RESET_WEIGHTS = False
EXP38_MODAL_CORPUS_PATH = "/data/corpus/mix_rft.jsonl"
# >>> EXP38 END
IN_PROJ_ONLY = False
...
# >>> EXP38 START
KAGGLE_DATASET = "huikang/nemotron-exp38-rft"
# >>> EXP38 END
MINUTES = 60
...
def run_training() -> None:
    ...
    if IS_KAGGLE:
        ...
        # >>> EXP38 START
        CORPUS_PATH = "/kaggle/input/datasets/ngoczhu/nemotron-mixes/mix_rft.jsonl"
        # >>> EXP38 END
        ...
        # >>> EXP38 START
        CORPUS_PATH = EXP38_MODAL_CORPUS_PATH
        # >>> EXP38 END
